...
public class SuperScoopWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SuperScoopWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SuperScoopIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SuperScoopIW/InitOutcome.xml").getDocumentElement();
